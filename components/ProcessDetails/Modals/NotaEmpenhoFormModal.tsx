...
export const NotaEmpenhoFormModal: React.FC<NotaEmpenhoFormModalProps> = ({ 
  ...
  const handleFileChange = async (selectedFile: File | undefined) => {
    ...
    try {
      ...
      const path = `execution/${processId}/ne_${timestamp}.pdf`;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!file || !filePath) {
      setError('Faça upload do PDF da Nota de Empenho');
      return;
    }
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-in zoom-in-95">
        ...
        <div className="px-6 py-4 border-b border-slate-200 bg-amber-50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900">Anexar Nota de Empenho</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <p className="text-sm text-blue-800">
              <strong>Nova regra:</strong> O PDF da Nota de Empenho deve ser exportado diretamente do <strong>SIAFE</strong> 
            ...
            {file ? (
              ...
              <>
                ...
                <p className="text-sm text-slate-700 font-medium mb-2">
                  Arraste o PDF da Nota de Empenho aqui
                </p>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-slate-300 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
