...
interface LegalProcess {
  ...
  interested: string;
  subject: string;
  origin: 'SOSFU' | 'SEPLAN' | 'GESTOR' | 'SGP';
  value: number;
  entryDate: string;
  deadline: string;
...
const MOCK_LEGAL_PROCESSES: LegalProcess[] = [
  ...
  { id: '2', protocol: 'TJPA-PROC-2026-0045', interested: 'Sec. Informática', subject: 'Aquisição Emergencial de Nobreaks', origin: 'SEPLAN', value: 15000.00, entryDate: '09/01/2026', deadline: '11/01/2026', status: 'TRIAGEM', assignedTo: null },
  ...
  { id: '6', protocol: 'TJPA-PROC-2026-0120', interested: 'Engenharia', subject: 'Laudo Técnico - Reforma', origin: 'SEPLAN', value: 0, entryDate: '05/01/2026', deadline: '10/01/2026', status: 'REDACAO', assignedTo: '3', isLate: true },
  { id: '7', protocol: 'TJPA-PROC-2026-0133', interested: 'Presidência', subject: 'Ajuste Orçamentário', origin: 'SEPLAN', value: 500000.00, entryDate: '12/01/2026', deadline: '12/01/2026', status: 'TRIAGEM', assignedTo: null },
];
