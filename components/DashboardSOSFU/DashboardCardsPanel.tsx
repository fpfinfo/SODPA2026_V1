...
import { Inbox, UserCog, FileText, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      ...
      >
        ...
        <div>
          {isLoading ? <Skeleton className="h-8 w-16 mb-1" /> : <h3 className="text-3xl font-black text-slate-800 mb-1">{sosfuStats.myTasksSolicitacoes || 0}</h3>}
      ...
      >
        ...
        <div>
          {isLoading ? <Skeleton className="h-8 w-16 mb-1" /> : <h3 className="text-3xl font-black text-slate-800 mb-1">{sosfuStats.myTasksPrestacoes || 0}</h3>}
