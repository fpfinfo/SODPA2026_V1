...
-- Gestor da Comarca de Mãe do Rio (atesta solicitações do suprido Ademário)
('100002', 'Maria Helena Costa Ferreira', 'chefe@tjpa.jus.br', 'Gestor da Comarca de Mãe do Rio', 'EFETIVO', true),
...
('100010', 'Caroline Valeati da Rocha', 'ajsefin01@tjpa.jus.br', 'Assessor Jurídico', 'COMISSIONADO', true),
('100011', 'João Carlos Pinage da Silva', 'ajsefin02@tjpa.jus.br', 'Assessor Jurídico', 'COMISSIONADO', true),
('100012', 'Tiago Madson Aragão Domingos', 'ajsefin03@tjpa.jus.br', 'Analista Jurídico', 'EFETIVO', true),
('100013', 'Kenia Imbiriba Hesketh', 'ajsefin04@tjpa.jus.br', 'Analista Jurídico', 'EFETIVO', true),
('100014', 'Sarah Tavares Carvalho Oliveira', 'ajsefin05@tjpa.jus.br', 'Analista Jurídico', 'EFETIVO', true),
('100015', 'Ary Cesar Coelho Luz Silva', 'ajsefin06@tjpa.jus.br', 'Técnico Jurídico', 'EFETIVO', true)
...
WHERE email IN (
  ...
  'ajsefin01@tjpa.jus.br', 'ajsefin02@tjpa.jus.br', 'ajsefin03@tjpa.jus.br', 'ajsefin04@tjpa.jus.br', 'ajsefin05@tjpa.jus.br', 'ajsefin06@tjpa.jus.br'
);
...
UPDATE profiles SET role = 'GESTOR', nome = 'Maria Helena Costa Ferreira' WHERE email = 'chefe@tjpa.jus.br';
...
UPDATE profiles SET role = 'ajsefin', nome = 'Caroline Valeati da Rocha' WHERE email = 'ajsefin01@tjpa.jus.br';
UPDATE profiles SET role = 'ajsefin', nome = 'João Carlos Pinage da Silva' WHERE email = 'ajsefin02@tjpa.jus.br';
UPDATE profiles SET role = 'ajsefin', nome = 'Tiago Madson Aragão Domingos' WHERE email = 'ajsefin03@tjpa.jus.br';
UPDATE profiles SET role = 'ajsefin', nome = 'Kenia Imbiriba Hesketh' WHERE email = 'ajsefin04@tjpa.jus.br';
UPDATE profiles SET role = 'ajsefin', nome = 'Sarah Tavares Carvalho Oliveira' WHERE email = 'ajsefin05@tjpa.jus.br';
...
-- | chefe@tjpa.jus.br        | Maria Helena Costa Ferreira   | GESTOR      | 123456  |
...
-- | ajsefin01@tjpa.jus.br    | Caroline Valeati da Rocha         | ajsefin     | 123456  |
-- | ajsefin02@tjpa.jus.br    | João Carlos Pinage da Silva       | ajsefin     | 123456  |
-- | ajsefin03@tjpa.jus.br    | Tiago Madson Aragão Domingos      | ajsefin     | 123456  |
-- | ajsefin04@tjpa.jus.br    | Kenia Imbiriba Hesketh            | ajsefin     | 123456  |
-- | ajsefin05@tjpa.jus.br    | Sarah Tavares Carvalho Oliveira   | ajsefin     | 123456  |
-- | ajsefin06@tjpa.jus.br    | Ary Cesar Coelho Luz Silva        | ajsefin     | 123456  |
